...
elevdat<-read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vT4C7olgh28MHskOjCIQGYlY8v5z1sxza9XaCccwITnjoafF_1Ntfyl1g7ngQt4slnQlseWT6Fk3naB/pub?gid=1550309563&single=true&output=csv")|>dplyr::mutate(year=factor(year))
elevdat
...
elevdat|>
  ...
  geom_line()  #year needs to be made into a factor first, use mutate after pipeline when loading the data 
...
combidat<-dplyr::left_join(elevdat2017,cdat2017,by="TransectPoint_ID")|> #always put the longest file first, 
