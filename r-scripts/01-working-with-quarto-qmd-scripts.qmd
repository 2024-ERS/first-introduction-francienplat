...
C<-A+B
print(C)
#calculate the mean of a string of numbers
mynumbers<- c(1,3,7,12,46)
base::mean(mynumbers)#use function mean from package base
?mean
```
...
# plot as a histogram #from library ggplot2, use function ggplot
